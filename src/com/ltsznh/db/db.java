...
public class db {
	...
	public static ConnectionPool getPool() {
		if (connPool == null || connPool.isClosed()) {
			try {
				...
				ServerLog.err("Server", "CreatePool", e);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				ServerLog.err("Server", "CreatePool", e);
			}
	...
	private static void initDataSource() throws Exception {
		ServerLog.log("Server", "getBasicDataSource", "获取数据源......");
		XML xr = new XML();
		...
		// ServerLog.log("DB", "", "url:" + url + "user:" + user + "pwd:" +
		// pwd);
		...
		ServerLog.log("Server", "DataSource Info:",
				new StringBuffer(
